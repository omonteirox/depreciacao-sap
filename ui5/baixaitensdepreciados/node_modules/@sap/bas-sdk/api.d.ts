...
export declare namespace core {
  ...
  /**
   * Sends a setup request for an action.
   * @param data - The data for the setup request, including:
   *  - startupServerUrl (string): The startup server URL.
   *  - jwt (string): The JWT for authentication.
   *  - form (Record<string, any>): The form data to send.
   *  - enforceSecurityVerification (boolean, optional): Whether to enforce security verification. Defaults to true.
   * @returns {Promise<any>} A promise that resolves to the response of the setup request.
   */
